	...
	<div class="class_album">		
		...
		<div class="div_album">
	        ...
	        <?php 
				...
				{				
		    ?>
				<img src="<?php echo $row_3['file']?>" width="110px" height="150px" style="border-radius: 5px;"/>
			<?php
			    }else{
			?>
			    <img src="<?php echo $row_3['file']?>" width="200px" height="150px" style="border-radius: 5px;/>
			<?php
			    }
			?>
			</div>
			<div class="" >
			    ...
			    <a href="visitor_scan_image.php?album_id=<?php echo $row_1['id']?>&id=<?php echo $id_1;?>&friend_name=<?php echo $friend_name;?>" >
	    ...
	    <div class="div_page">	    		
		    ...
		    <?php
		    	...
		    	{		    		    
		    		echo "<a href='visitor_scan_album.php?page=".($page_count)."&id=".($id_1)."&friend_name=".($friend_name)." '>尾页|</a>";
		    		echo "<a href='visitor_scan_album.php?page=".($page+1)."&id=".($id_1)."&friend_name=".($friend_name)." '>|下一页</a>";
		    	}
		    	if($page!=1&&$page!=$page_count)
		    	{
		    		echo "<a href='visitor_scan_album.php?page=".($page-1)."&id=".($id_1)."&friend_name=".($friend_name)." '>上一页|</a>";
		    		echo "<a href='visitor_scan_album.php?page=".($page+1)."&id=".($id_1)."&friend_name=".($friend_name)." '>|下一页</a>";
		    	}
		    	if($page!=1&&$page==$page_count)
		    	{
		    		echo "<a href='visitor_scan_album.php?page=1&id=".($id_1)."&friend_name=".($friend_name)." '>首页|</a>";
		    		echo "<a href='visitor_scan_album.php?page=".($page-1)."&id=".($id_1)."&friend_name=".($friend_name)." '>|上一页</a>";
		    	}    	     
		    ?> 		        
            </span> 
