<?php
    ...
    if($_GET['talkabout_id'])
    {
    	...
    	$browse=$row_4['browse']+0;
    	
    	$sql_7="UPDATE `user_talkabout` SET `browse`='$browse' WHERE id=".$talkabout;
    	$result_7 = mysql_query($sql_7);
    }
    if(isset($_POST["submit1"]) && $_POST["submit1"] == "回复评论"){    	
    	
    	$comment=$_POST["comment"];
    	$cm_id=$_POST["cm_id"];
    	
    	$sql2 = "INSERT INTO `user_replay`(`date`,`content`,`cm_id`,`name`) VALUES (now(),'$comment','$cm_id','$name')";
...
<html>
	...
	<body style="background-image: url(../../bg_image/16.jpg);background-size: 1366px,800px;position: relative;">
		<hr />
		<a href="user_control.php?user_name=<?php echo $user_name;?>" class="a_return"><input type="button" value="返回上一页" style="width: 80px;height: 30px;"/></a>
		...
		<form action="" method="post">	
		    ...
		    <tr bgcolor="white" style="position: relative;">			
			    <td ><img src="../<?php echo $row_insert1['headimg'] ?>" class="headimg"/>
		    	    ...
		    	    <a href="delete_talkabout.php?talkabout_id=<?php echo $row['id']?>&user_name=<?php echo $user_name;?>">
		    ...
		    <?php
		        $sql1=" SELECT `id`,`ta_id`,`date`,`content`,`friend_name` FROM `visitor_comment` WhERE name='$name'";
		    ...
		    <tr>		    	
		    	<td>
		    		...
		    		<a href="delete_comment.php?comment_id=<?php echo $row1['id']?>&user_name=<?php echo $user_name;?>">
		    			<img src="../../bg_image/18.jpg" style="width: 27px;height: 30px;"/>
		    		</a>
		    	</td>		    			    		
		    </tr>
		    <tr>
		        ...
		        <tr>		    	
		    	    <td style="background: white;">
		        		...
		        		<a href="delete_reply.php?replay_id=<?php echo $row3['id']?>&user_name=<?php echo $user_name;?>">
		        			<img src="../../bg_image/18.jpg" style="width: 27px;height: 30px;"/>
		        		</a>		    	    		
		    	    </td>		    			    		
		        </tr>
		    ...
		    <tr>
		    	<td><textarea type="text" name="comment" class="class_text" placeholder="回复评论" style="width: 500px;height: 100px;"></textarea></td>
		    </tr>
		    <tr>
		    	<td>
		    		<a href="#"><input type="submit" name="submit1" value="回复评论" class="a_btn" />		    			
		    		</a>
		    	</td>
		    </tr>
