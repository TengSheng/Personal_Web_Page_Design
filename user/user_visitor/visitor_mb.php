...
<html>
	...
	<body style="background-image: url(../../bg_image/16.jpg);background-size: 1366px,800px;position: relative;">
		...
		?>
		<form action="visitor_mb.php" method="post" name="myform" onsubmit="return CheckPost();" style="position: relative;"> 
			<?php 
        ...
        <table border="0" cellspacing="1" cellpadding="5" width="500px" bgcolor="aqua" style="position: absolute;top: 50px;left: 400px;">
		<?php
		...
		<form action="" method="post" name="myform1">	
		    ...
		    <tr bgcolor="white">
		    	<td >
		    		...
		    		&nbsp;<?php echo $row_select_1['friend_name'];?>：<?php echo htmltocode($row['content'])?>
		    	</td>			
		    </tr>
		    <?php
	    ...
	    <tr>
		    ...
		    <?php
		    	...
		    	{		    		    
		    		echo "<a href='visitor_mb.php?page=".($page_count)." '>尾页|</a>";
		    		echo "<a href='visitor_mb.php?page=".($page+1)." '>|下一页</a>";
		    	}
		    	if($page!=1&&$page!=$page_count)
		    	{
		    		echo "<a href='visitor_mb.php?page=".($page-1)." '>上一页|</a>";
		    		echo "<a href='visitor_mb.php?page=".($page+1)." '>|下一页</a>";
		    	}
		    	if($page!=1&&$page==$page_count)
		    	{
		    		echo "<a href='visitor_mb.php?page=1 '>首页|</a>";
		    		echo "<a href='visitor_mb.php?page=".($page-1)." '>|上一页</a>";
		    	}    	     
		    ?> 		        
            </span>
