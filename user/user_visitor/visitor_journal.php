        ...
        ?>	
            <tr bgcolor="lightcyan">
            	<td>
            		...
            		<a href="visitor_jl_display.php?journal_id=<?php echo $row['id']?>">
	    ...
	    ?>
	    	<tr bgcolor="lightgray">
		        ...
		        <?php
		    	    ...
		    	    {		    		    
		    		    echo "<a href='visitor_journal.php?page=".($page_count)."&i=".($i=$page_count*$page_size-7)."'>尾页|</a>";
		    		    echo "<a href='visitor_journal.php?page=".($page+1)."&i=".($i=9)."'>|下一页</a>";
		    	    }
		    		if($page!=1&&$page!=$page_count)
		    	    {
		    		    echo "<a href='visitor_journal.php?page=".($page-1)."&i=".($i-16)."'>上一页|</a>";
		    		    echo "<a href='visitor_journal.php?page=".($page+1)."&i=".$i."'>|下一页</a>";
		    	    }
		    	    if($page!=1&&$page==$page_count)
		    	    {
		    		    echo "<a href='visitor_journal.php?page=1&i=".($i=1)."'>首页|</a>";
		    		    echo "<a href='visitor_journal.php?page=".($page-1)."&i=".($i=($page_count-1)*$page_size-2)."'>|上一页</a>";
		    	    }    	     
		        ?> 		        
		        </td>  
		    </tr> 
