...
//		    $result_1 = mysql_query($sql_1);  		    
		...
		<div class="div_album">
			...
			<div class="">
			    ...
			    <a href="visitor_scan_image.php?album_id=<?php echo $row_1['id']?>&user_name=<?php echo $user_name;?>" >
	    ...
	    <div class="div_page">	    		
		    ...
		    <?php
		    	...
		    	{		    		    
		    		echo "<a href='user_scan_album.php?page=".($page_count)." '>尾页|</a>";
		    		echo "<a href='user_scan_album.php?page=".($page+1)." '>|下一页</a>";
		    	}
		    	if($page!=1&&$page!=$page_count)
		    	{
		    		echo "<a href='user_scan_album.php?page=".($page-1)." '>上一页|</a>";
		    		echo "<a href='user_scan_album.php?page=".($page+1)." '>|下一页</a>";
		    	}
		    	if($page!=1&&$page==$page_count)
		    	{
		    		echo "<a href='user_scan_album.php?page=1 '>首页|</a>";
		    		echo "<a href='user_scan_album.php?page=".($page-1)." '>|上一页</a>";
		    	}    	     
		    ?> 		        
            </span> 
